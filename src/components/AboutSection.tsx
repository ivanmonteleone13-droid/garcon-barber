        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="aspect-[4/5] overflow-hidden rounded-3xl shadow-xl">
            {aboutImage ? (
              ...
              <div
                className="flex h-full items-center justify-center bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)]/30 text-6xl"
                aria-hidden
              >
                💈
              </div>
          ...
          <div>
            ...
            <div className="mt-6 rounded-2xl border border-[var(--primary)]/10 bg-[var(--accent)] px-6 py-4">
              ...
              <p className="text-sm text-[var(--primary)]/70">
                {business.reviewCount}+ omdömen på Bokadirekt · Sedan {business.foundedYear}
              </p>
            </div>
